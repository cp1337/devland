				...
				if(readXMLInteger(itemNode, "id", intValue)){
					...
					while(itemAttributesNode){
						if(readXMLString(itemAttributesNode, "key", strValue)){
							if(strcasecmp(strValue.c_str(), "type") == 0){
								if(readXMLString(itemAttributesNode, "value", strValue)){
									if(strcasecmp(strValue.c_str(), "key") == 0){
									 ...
									 else if(strcasecmp(strValue.c_str(), "teleport") == 0){ 
                                          it.type = ITEM_TYPE_TELEPORT; 
                                    } 
                                    else if(strcasecmp(strValue.c_str(), "door") == 0){ 
								...
								if(readXMLInteger(itemAttributesNode, "value", intValue)){
                                    ...
                                    if(g_config.getString(ConfigManager::CAP_SYSTEM) == "yes"){                                  
							...
							else if(strcasecmp(strValue.c_str(), "attackspeedadd") == 0){
								if(readXMLInteger(itemAttributesNode, "value", intValue)){
									it.attackSpeedAdd = intValue;
								}
							}
							else if(strcasecmp(strValue.c_str(), "attackspeedremove") == 0){
								if(readXMLInteger(itemAttributesNode, "value", intValue)){
									it.attackSpeedRemove = intValue;
								}
							}
							...
							else if(strcasecmp(strValue.c_str(), "blockprojectile") == 0){ 
                                if(readXMLInteger(itemAttributesNode, "value", intValue)){ 
                                    it.blockProjectile = (intValue == 1); 
                                } 
                            } 
                            else if(strcasecmp(strValue.c_str(), "floorchange") == 0){ 
                                if(readXMLString(itemAttributesNode, "value", strValue)){ 
                                     if(strcasecmp(strValue.c_str(), "down") == 0){ 
                                          it.floorChangeDown = true; 
                                     } 
                                     else if(strcasecmp(strValue.c_str(), "north") == 0){ 
                                          it.floorChangeNorth = true; 
                                     } 
                                     else if(strcasecmp(strValue.c_str(), "south") == 0){ 
                                          it.floorChangeSouth = true; 
                                     } 
                                     else if(strcasecmp(strValue.c_str(), "west") == 0){ 
                                          it.floorChangeWest = true; 
                                     } 
                                     else if(strcasecmp(strValue.c_str(), "east") == 0){ 
