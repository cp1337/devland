...
public:
	...
	void setName(const std::string& newname) {mType->name = newname;}
	void setName2(const std::string& newname) {mType->nameDescription = newname;}
	...
	bool isGhost() const {return mType->isGhost;}
