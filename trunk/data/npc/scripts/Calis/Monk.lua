...
function onCreatureSay(cid, type, msg)
	...
	distance = getDistanceTo(cid)
		...
		elseif msgcontains(msg, 'devfried') then
        		selfSay("It\'s my brother. He live on Lakeshire Island.", cid)
		...
		elseif msgcontains(msg, 'citizens') then
        		selfSay("Many people live in this city. Walk around and talk to them.", cid)
