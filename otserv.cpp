...
#ifdef __TFS_QUESTS__
#include "quests.h"
Quests g_quests;
#endif //__TFS_QUESTS__
...
#endif
	std::cout << "::===== DevLand_8.21_Distro_Version 0.1.1.2d ====" << std::endl;
	std::cout << "::  Based on Otserv Version 0.6.0 - SVN Preview " << std::endl;
	std::cout << ":: ==============================================" << std::endl;
...
//	LOG_MESSAGE("main", EVENT, 1, "Starting server");
	...
	//load vocations
	filename.str("");
	filename << g_config.getString(ConfigManager::DATA_DIRECTORY) << "xml/vocations.xml";
	...
	//load commands
	filename.str("");
	filename << g_config.getString(ConfigManager::DATA_DIRECTORY) << "xml/commands.xml";
	std::cout << ":: Loading " << filename.str() << "... ";
	...
	// load outfits data
	filename.str("");
	filename << g_config.getString(ConfigManager::DATA_DIRECTORY) << "xml/outfits.xml";
	std::cout << ":: Loading " << filename.str() << "... ";
	...
	filename.str("");
	filename << g_config.getString(ConfigManager::DATA_DIRECTORY) << "xml/admin.xml";
	...
	std::cout << "[done]" << std::endl;
		    ...
		    std::cout << ":: Loading players record...  ";
    ...
    #ifdef __TFS_QUESTS__
	filename.str("");
	filename << g_config.getString(ConfigManager::DATA_DIRECTORY) << "xml/quests.xml";
	std::cout << ":: Loading " << filename.str() << "... ";
