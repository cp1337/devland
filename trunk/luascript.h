...
protected:
	...
	static int luaDoPlayerSummonClone(lua_State *L);
#endif		
	...
	static int luaDoPlayerAddHealthMax(lua_State *L);
	static int luaDoPlayerAddManaMax(lua_State *L);
	#endif
...
#ifdef __GET_OUTFIT__
	static int luaGetPlayerLookType(lua_State *L);
	static int luaGetPlayerLookHead(lua_State *L);
	static int luaGetPlayerLookBody(lua_State *L);
	static int luaGetPlayerLookLegs(lua_State *L);
	static int luaGetPlayerLookFeet(lua_State *L);
	static int luaGetPlayerLookAddons(lua_State *L);
#endif    	
