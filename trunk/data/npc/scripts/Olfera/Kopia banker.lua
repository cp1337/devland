...
--- Change gold continue ----------------------------------------------------------------------------
		...
		elseif getCount(msg) and talk_state == 10 then
			count = getCount(msg)
			count2 = getCount(msg)*100
			selfSay('So you would like me to change ' .. count2 .. ' of your gold coins into ' .. count .. ' platinum coins?')
			talk_state = 20

		elseif getCount(msg) and talk_state == 14 then
			count = getCount(msg)
			count2 = getCount(msg)*100
			selfSay('So you would like me to change ' .. count2 .. ' of your platinum coins into ' .. count .. ' crystal coins?')
			talk_state = 24
--- Yes! Part ------------------------------------------------------------------------------------------
			...
			if talk_state == 20 then
				if doPlayerRemoveItem(cid,2148, count2) == 1 then
					doPlayerAddItem(cid,2152,count)
				else
			...
			if talk_state == 24 then
				if doPlayerRemoveItem(cid,2152, count2) == 1 then
