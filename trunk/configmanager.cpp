...
bool ConfigManager::loadFile(const std::string& _filename)
{
    ...
    m_confInteger[CORPSE_MUTED] = getGlobalNumber(L, "corpsemuted", 10);
    #endif
	...
	m_confInteger[PROTECT_LEVEL] = getGlobalNumber(L, "protectLevel", 20);
